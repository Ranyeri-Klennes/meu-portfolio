...
export const Footer = ({ simple = false }: FooterProps) => (
  <footer id="contato" className={`max-w-5xl mx-auto text-center reveal ${simple ? 'pt-8 pb-12' : 'pt-16 pb-8 sm:pt-32 sm:pb-12 px-4 sm:px-6'}`}>
    {!simple && (
    ...
    <div className={`${simple ? 'mt-0' : 'mt-10 sm:mt-16'} text-slate-500 dark:text-slate-500 text-sm font-medium flex flex-col sm:flex-row justify-between items-center gap-4 px-2 sm:px-8`}>
